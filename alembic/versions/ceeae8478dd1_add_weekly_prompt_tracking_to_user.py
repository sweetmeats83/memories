"""add weekly prompt tracking to user

Revision ID: ceeae8478dd1
Revises: b13f8c288ecb
Create Date: 2025-08-29 04:20:37.543293
...
revision: str = 'ceeae8478dd1'
down_revision: Union[str, Sequence[str], None] = 'b13f8c288ecb'
...
def upgrade() -> None:
    # weekly_current_prompt_id (add if missing) + FK + index
    ...
    # weekly_on_deck FK (column already added by prior migration)
...
def downgrade() -> None:
    # Only undo what this file added
    try:
    ...
    try:
        ...
        pass
    if _has_column("user", "weekly_current_prompt_id"):
